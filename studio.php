            ...
            <div class="whole_map">
                <svg xmlns="http://www.w3.org/2000/svg" baseProfile="tiny" id="svg_map" x="0px" y="0px" viewBox="0 20 1280 780" preserveAspectRatio="xMidYMid"  xml:space="preserve" xmlns:xml="http://www.w3.org/XML/1998/namespace">
                    <g id="map_width" transform='translate(240 205) scale(1.375) translate(-230 -105)'>
                        <?php $site_root_url = home_url('/') ; ?>
                        <g id="all_russia">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'russia' ; ?>">
                        ...
                        <g id="all_canada">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'canada' ; ?>">
                        ...
                        <g id="all_usa">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'usa' ; ?>">
                        ...
                        <g id="all_bahamas">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'bahamas' ; ?>">
                        ...
                        <g id="all_dominican">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'dominican' ; ?>">
                        ...
                        <g id="all_panama">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'panama' ; ?>">
                        ...
                        <g id="all_barbados">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'barbados' ; ?>">
                                <path id="st_vincent_barbados" d="M282.07,297.85l-1.23,0.89l0.97,1.78l1.59-0.89L282.07,297.85L282.07,297.85z"/>
                            </a>
                        </g>
                        <g id="uk">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'uk' ; ?>">
                        ...
                        <g id="all_france">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'france' ; ?>">
                        ...
                        <g id="all_italy">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'italy' ; ?>">
                        ...
                        <g id="all_spain">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'spain' ; ?>">
                        ...
                        <g id="all_portugal">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'portugal' ; ?>">
                        ...
                        <g id="all_germany">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'germany' ; ?>">
                        ...
                        <g id="all_belgium">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'belgium' ; ?>">
                        ...
                        <g id="all_netherlands">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'netherlands' ; ?>">
                        ...
                        <g id="all_czech">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'czech' ; ?>">
                        ...
                        <g id="all_poland">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'poland' ; ?>">
                        ...
                        <g id="all_ukraine">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'ukraine' ; ?>">
                        ...
                        <g id="all_hungary">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'hungary' ; ?>">
                        ...
                        <g id="all_slovakia">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'slovakia' ; ?>">
                        ...
                        <g id="all_bulgaria">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'bulgaria' ; ?>">
                        ...
                        <g id="all_egypt">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'egypt' ; ?>">
                        ...
                        <g id="all_turkey">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'turkey' ; ?>">
                        ...
                        <g id="all_oman">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'oman' ; ?>">
                        ...
                        <g id="all_emirates">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'emirates' ; ?>">
                        ...
                        <g id="all_india">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'india' ; ?>">
                        ...
                        <g id="all_china">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'china' ; ?>">
                        ...
                        <g id="all_vietnam">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'vietnam' ; ?>">
                        ...
                        <g id="all_thailand">
                            <a class="simple-ajax-popup" href="<?php echo $site_root_url . 'thailand' ; ?>">
