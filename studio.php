...
<?php get_header(); ?>
            ...
            <div class="common_description container">
                <div class="common_description_item">
                    <p class="common_description_text" >
                        <span class="highlighted_symbol">Б</span>алет «Мипарти» - это бренд в хореографическом и театральном искусстве, который, создавая свои шоу-программы, танцевальные спектакли, мюзиклы и синтезируя различные виды классического и современного искусства, развивает лучшие танцевальные традиции.
                    </p>
                    <p class="common_description_text_full">
                        <span class="highlighted_symbol">Н</span>а его базе был создан ряд разнообразных по танцевальному стилю шоу-проектов не только для многочисленных площадок г. Харькова, но и для кабаре, пятизвёздочных отелей, развлекательных парков, ресторанов и ночных клубов в Украине и за рубежом.
                    </p>
                    <p class="common_description_text_full">
                        <span class="highlighted_symbol">Б</span>алет «Мипарти» принимает активное участие в благотворительных концертах, проектах департамента культуры г. Харькова, плодотворно сотрудничает со звёздами эстрады и международными компаниями, успешно гастролирует более чем в 20 странах мира.
                    </p>
                ...
                <div id="content_spheres">
                    ...
                    <ul id="content_lines">
                        <li class="content_lines_top_left">
                            <a class="content_spheres_top_left_link" href="<?php echo HOME_URL_ORIGIN . '/rider-3' ; ?>">
                        ...
                        <li class="content_lines_top_right">
                            <a class="content_spheres_top_right_link" href="<?php echo HOME_URL_ORIGIN . '/studio-photos' ; ?>">
                        ...
                        <li class="content_lines_bottom_left">
                            <a class="content_spheres_bottom_left_link" href="<?php echo HOME_URL_ORIGIN . '/studio-videos' ; ?>">
                            ...
                            <span class="moving_ray_bottom_left"></span>
                        </li>
                        <li class="content_lines_bottom_right">
                            <a class="content_spheres_bottom_right_link" href="#">
                                <p class="content_spheres_bottom_right_tooltip">Наш   Мир   танца</p>
                                <div class="move_to_map">
                            ...
                            <span id="layerBall_bottom_right"></span>
                            <span class="moving_ray_bottom_right"></span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <hr class="separator" id="anchor_from_earth"/>

        <section class="world_map">

            <div class="world_map_countries container"></div>

            <div class="whole_map">
                <svg xmlns="http://www.w3.org/2000/svg" baseProfile="tiny" id="svg_map" x="0px" y="0px" viewBox="0 20 1280 780" preserveAspectRatio="xMidYMid"  xml:space="preserve" xmlns:xml="http://www.w3.org/XML/1998/namespace">
                    <g id="map_width" transform='translate(240 205) scale(1.375) translate(-230 -105)'>
                        <g id="all_russia">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/russia' ; ?>">
                                ...
                                <path id="novaya_zemlya_north" d="M584.49,51.98l-0.52,2.43l-3.96,3.47l-8.44,1.91l-6.89,11.45l-1.21,3.3l6.89,1.74l1.03-4.16l2.07-6.42l5.34-2.78l4.48-3.47l3.27-1.39h1.72v-4.68L584.49,51.98L584.49,51.98z"/>
                                <path id="novaya_zemlya_south" d="M562.28,77.31l4.65,0.52l1.55,5.38l3.96,4.16l-1.38,2.78h-2.41l-2.24-2.6l-4.99-0.17l-2.07-2.78v-1.91l3.1-0.87L562.28,77.31L562.28,77.31z"/>
                                ...
                                <path id="novaya_sibir" d="M746.94,10.09l1.79,3.39l6.96-0.79l1.91-2.49l-0.45-2.15l-1.91-0.79l-1.79,1.36l-5.16,1.13L746.94,10.09L746.94,10.09z"/>
                                <path id="prince_george" d="M547.82,38.79l1.72,0.69l-1.21,2.08v2.95l-2.58,1.56H543l-1.55-1.91l0.17-2.08l1.21-1.56h2.41L547.82,38.79L547.82,38.79z"/>
                                ...
                                <path id="st_lawrence_island" d="M881.29,38.39l-2.36,1.54l-0.56,1.96l1.11,1.26l2.5-0.84l2.5,0.84l1.39,0.42l-0.14-4.62L881.29,38.39L881.29,38.39z"/>
                            </a>
                        </g>
                        <g id="all_canada">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/canada' ; ?>">
                                ...
                                <path id="prince_patrick" d="M214.15,24.05l-1.77,3.13l8.65,3.13l3.1-4.69l1.33,3.13h2.22l4.21-4.69l-5.1-1.34l-2-1.56l-2.66,2.68L214.15,24.05L214.15,24.05z"/>
                                ...
                                <path id="ellef_ringnes" d="M256.5,23.38l-0.44,1.56l-1.11,1.56v2.23l4.21-0.67l4.43,3.8h1.55v-3.8l-4.43-4.92L256.5,23.38L256.5,23.38z"/>
                                <path id="amund_ringnes" d="M267.81,27.85l1.77,2.01l-1.55,2.68l1.11,2.9l4.88-2.68v-2.01l-2.88-3.35L267.81,27.85L267.81,27.85z"/>
                                <path id="axel_heiberg" d="M274.24,22.71l0.22,3.57h5.99l1.55,1.34l-0.22,1.56l-5.32,0.67l3.77,5.14l5.1,0.89l7.09-3.13l-10.2-15.42l-3.1,2.01l0.22,2.68l-3.55-1.34L274.24,22.71L274.24,22.71z"/>
                                ...
                                <path id="prince_of_wales" d="M249.63,57.79l-2.88-1.34l-1.55,2.01l3.1,4.92l0.22,4.69l6.65-4.02v-5.81l2.44-2.46l-2.44-1.79h-3.99L249.63,57.79L249.63,57.79z"/>
                        ...
                        <g id="all_usa">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/usa' ; ?>">
                                ...
                                <path id="haida_gwaii" d="M133.83,128.41l-1.7,3.26l0.59,2.31l1.11,0.69l-0.26,0.94l-1.19,0.34l0.34,3.43l1.28,1.29l1.02-1.11l-1.28-3.34l0.76-2.66l1.87-2.49l-1.36-2.31L133.83,128.41L133.83,128.41z"/>

                            </a>
                        </g>
                        <g id="all_bahamas">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/bahamas' ; ?>">
                                ...
                                <path id="grand_bahama" d="M243.96,256.21l-1.55-0.39l-0.29-1.95l-1.64-0.58l1.06-1.07l1.93,0.68l1.45,0.88L243.96,256.21L243.96,256.21z"/>
                            </a>
                        </g>
                        <g id="all_dominican">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/dominican' ; ?>">
                                <path id="haiti_dominican_border" fill="#FFC318" d="M250.87,275.38l-1.67,1.71l1.91,0.78l0.28,2.39l-4.23,0.37l0.43,2.3l1.23,0.09l0.71-1.06l4.94,0.16l0.89,1.71l1.14-1.34l3.33-0.9l2.93,0.62l0.34-1.77l-5.28-3.45l-3.42-1.28L250.87,275.38L250.87,275.38z"/>
                                <path id="domincan_republic" d="M263.11,280.44l-5.29-3.46l-2.5-0.85l-0.84,6l0.88,1.69l1.15-1.33l3.35-0.89l2.91,0.62L263.11,280.44L263.11,280.44z"/>
                        ...
                        <g id="all_panama">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/panama' ; ?>">
                        ...
                        <g id="all_barbados">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/barbados' ; ?>">
                                <path id="st_vincent_barbados" d="M282.07,297.85l-1.23,0.89l0.97,1.78l1.59-0.89L282.07,297.85L282.07,297.85z"/>
                            </a>
                        </g>
                        <g id="uk">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/uk' ; ?>">
                        ...
                        <g id="all_france">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/france' ; ?>">
                        ...
                        <g id="all_italy">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/italy' ; ?>">
                        ...
                        <g id="all_spain">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/spain' ; ?>">
                        ...
                        <g id="all_portugal">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/portugal' ; ?>">
                        ...
                        <g id="all_germany">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/germany' ; ?>">
                        ...
                        <g id="all_belgium">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/belgium' ; ?>">
                        ...
                        <g id="all_netherlands">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/netherlands' ; ?>">
                        ...
                        <g id="all_czech">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/czech' ; ?>">
                        ...
                        <g id="all_poland">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/poland' ; ?>">
                        ...
                        <g id="all_ukraine">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/ukraine' ; ?>">
                        ...
                        <g id="all_hungary">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/hungary' ; ?>">
                        ...
                        <g id="all_slovakia">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/slovakia' ; ?>">
                        ...
                        <g id="all_bulgaria">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/bulgaria' ; ?>">
                        ...
                        <g id="all_egypt">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/egypt' ; ?>">
                        ...
                        <g id="all_turkey">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/turkey' ; ?>">
                        ...
                        <g id="all_oman">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/oman' ; ?>">
                        ...
                        <g id="all_emirates">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/emirates' ; ?>">
                        ...
                        <g id="all_india">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/india' ; ?>">
                        ...
                        <g id="all_china">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/china' ; ?>">
                        ...
                        <g id="all_vietnam">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/vietnam' ; ?>">
                        ...
                        <g id="all_thailand">
                            <a class="simple-ajax-popup" href="<?php echo HOME_URL_ORIGIN . '/thailand' ; ?>">
                        ...
                        <g id="others_items">
                            ...
                            <path id="st_lucia" d="M281.98,294.03l-0.71,1.51l1.15,1.24l1.5-0.8L281.98,294.03L281.98,294.03z"/>
                ...
                <div id="indicator"><a class="inner-ajax-popup"></a></div>
            </div>
        </section>
