<?php
/**
 * Template Name: school-videos
 */
?>

<?php get_header(); ?>

    <section class="studio_videos">
        <!--ONE ITEM-->

        <?php
        $school_videos_items = new WP_Query(array(
            'post_type'     => 'videos_school',
            'post_per_page' => -1,
            'order'         => 'ASC'
        ));
        while ($school_videos_items->have_posts()) :
            $school_videos_items->the_post();
            ?>
                        ...
                        <div class="common_description">
                            <div class="common_description_item">
                                <div class="common_description_text">
                                    ...
                                    $visible_paragraphs = explode(PHP_EOL,$visible_video_text); // use PHP constant 'PHP_EOL' like line-break-delimiter
                                ...
                                <div class="common_description_text_full">
                                    ...
                                    $invisible_paragraphs = explode(PHP_EOL,$invisible_video_text);
